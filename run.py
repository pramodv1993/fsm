...
if __name__=="__main__":
    ...
    parser.add_argument("--type", type=str, default="candy_counter", help="possible args: candy_counter")
    parser.add_argument("--inp", type=str, help="a string with sequence of symbols (eg: slllss for candy_counter fsm)")
    parser.add_argument("--file", type=str, help="name of the input file")
    parser.add_argument("--persist", action='store_true', help="if a failure is encountered, then store the state of the fsm as a file: fsm_YY_MM_HH.pkl")
